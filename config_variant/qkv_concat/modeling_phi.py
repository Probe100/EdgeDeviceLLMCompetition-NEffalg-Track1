...
class PhiAttention(nn.Module):
    ...
    def __init__(self, config: PhiConfig, layer_idx: Optional[int] = None):
        ...
        self.qkv_proj = nn.Linear(self.hidden_size, (self.num_heads + self.num_key_value_heads * 2) * self.head_dim, bias=True)
    ...
    def forward(
        ...
        query_states, key_states, value_states = torch.split(
            qkv_states, [self.num_heads * self.head_dim, (self.num_heads + self.num_key_value_heads) * self.head_dim], dim=2
        )
...
class PhiSdpaAttention(PhiAttention):
    ...
    def forward(
        ...
        qkv_states = self.qkv_proj(hidden_states)
        query_states, key_states, value_states = torch.split(
            qkv_states, [self.num_heads * self.head_dim, 

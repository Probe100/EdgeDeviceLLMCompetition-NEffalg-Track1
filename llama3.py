...
def main(args):
    ...
    if args.save_model:
        ...
        os.system(
            "cp ./LLMPruner/models/hf_llama3_a0m4/configuration_llama.py ./LLMPruner/models/hf_llama3_a0m4/modeling_llama.py ./"
            + args.save_path
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_path", type=str, default="pruned_llama3", help='path to save the model')

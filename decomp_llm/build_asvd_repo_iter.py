...
from topk_compress import iteratively_topk_sensitivity_compress_with_recovery
...
def main(args):
    ...
    if args.hadamard or args.hadamard_both:
        ...
        if args.whitening_profiling_path is not None:
            ...
            model.seqlen = 256
            profiling_mat = profile_svdllm_low_resource(args.model_id, model, calib_loader, args.DEV, args.norm)
    ...
    if args.naive_truncation:
        ...
        #    sensitivity = calib_sensitivity_ppl_greedy(model, calib_loader, args, args.use_cache)
            ...
            iteratively_topk_sensitivity_compress_with_recovery(model, calib_loader, args.delta, args.topk, args, use_cache=False)
        elif args.hadamard:
